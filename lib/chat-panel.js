...
class ChatPanel {
  constructor(serializedState) {
    ...
    this._commandsDisposable = atom.commands.add(this.element, {  // B5: store for dispose
    ...
    this._contextMenuDisposable = atom.contextMenu.add({  // B4: store for dispose
  ...
  destroy() {
    if (this._commandsDisposable)    { this._commandsDisposable.dispose();    this._commandsDisposable    = null; } // B5
    if (this._contextMenuDisposable) { this._contextMenuDisposable.dispose(); this._contextMenuDisposable = null; } // B4
