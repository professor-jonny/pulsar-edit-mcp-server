...
const TOOL_CATALOGUE = [
  ...
  { name: "delete-line-range",       group: "edit",        desc: "Delete a contiguous block of lines. inFunction deletes the entire named function body. betweenHint:{start,end} resolves both boundaries from content anchors. afterString resolves the start line from content. expectedContent:'text' verifies the target range before deleting when using raw startLine/endLine -- recommended, since that path has no other content check. dryRun previews what will be removed. RESPONSE: \u2705 delete-line-range \u2014 line N, -M lines [tags]. Followed by \u26a0\ufe0f lint: if linter fires near the deletion point." },
  ...
  { name: "get-structural-anchors",  group: "edit",        desc: "List section banners (sectionHint) and #ifdef blocks (preprocBlock) in the active file. Call this before insert or delete-block when you need an anchor name to use." },
  // FileOps
