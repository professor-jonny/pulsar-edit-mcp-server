...
//   smartSuggestion(ctx)
//   successNudge(ctx)
//   ambiguityCheck({ needle, fullText, noScopeHint, toolName, isCodeFile, existingMatchLines })
...
// ---------------------------------------------------------------------------
// Consecutive failure counters — module scope, survive across tool calls,
...
const replaceBlockFailures = { count: 0 }; // replace-block     (consecutive, for tool-switch hint)
