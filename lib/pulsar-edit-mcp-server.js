  ...
  showEditStats() {
    ...
    const panel = atom.workspace.addModalPanel({
      item: (() => {
        ...
        // Derive tool list dynamically from editStats keys — single source of truth.
        // key = underscore name (matches editStats), label = hyphenated display name.
        const tools = Object.keys(s).map(key => ({
          key,
