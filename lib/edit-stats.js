...
// covers all resolveScope hints plus nearLine (positional) and the content-pair mode.
...
const editStats = {
  ...
  delete: {
    hits: 0,
    fails: { outOfRange: 0, inverted: 0, anchorNotFound: 0, anchorAmbiguous: 0, startNotFound: 0, endNotFound: 0, expectedContentMismatch: 0 },
  ...
  read: {
    hits: 0,
    fails: { outOfRange: 0, anchorNotFound: 0, ambiguous: 0 },
...
const TOOL_REGISTRY = [
  ...
  { key: 'delete',                group: 'edit',   countAs: 'fault', extras: ['dryRuns'] },
